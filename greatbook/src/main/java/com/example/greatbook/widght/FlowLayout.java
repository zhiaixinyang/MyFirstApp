...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = DpUtils.sp2px(13.0f);
        default_horizontal_spacing = DpUtils.dp2px(8.0f);
        default_vertical_spacing = DpUtils.dp2px(4.0f);
        default_horizontal_padding = DpUtils.dp2px(0.0f);
        default_vertical_padding = DpUtils.dp2px(0.0f);

        final TypedArray attrsArray = context.obtainStyledAttributes(attrs,
                R.styleable.FlowLayoutItemTags,
                defStyleAttr,
                R.style.FlowLayoutItemTags);
        try {
            textColor = attrsArray.getColor(R.styleable.FlowLayoutItemTags_item_textColor, default_text_color);
            backgroundColor = attrsArray.getColor(R.styleable.FlowLayoutItemTags_item_backgroundColor,
                    default_background_color);
            selectedTextColor = attrsArray.getColor(R.styleable.FlowLayoutItemTags_item_selectedTextColor,
                    default_checked_text_color);
            selectedBackgroundColor = attrsArray.getColor(
                    R.styleable.FlowLayoutItemTags_item_selectedBackgroundColor, default_checked_background_color);
            textSize = attrsArray.getDimension(R.styleable.FlowLayoutItemTags_item_textSize, default_text_size);
            horizontalSpacing = (int) attrsArray.getDimension(
                    R.styleable.FlowLayoutItemTags_item_horizontalSpacing, default_horizontal_spacing);
            verticalSpacing = (int) attrsArray.getDimension(R.styleable.FlowLayoutItemTags_item_verticalSpacing,
                    default_vertical_spacing);
            horizontalPadding = (int) attrsArray.getDimension(
                    R.styleable.FlowLayoutItemTags_item_horizontalPadding, default_horizontal_padding);
            verticalPadding = (int) attrsArray.getDimension(R.styleable.FlowLayoutItemTags_item_verticalPadding,
                    default_vertical_padding);
            multiChooseable = attrsArray.getBoolean(R.styleable.FlowLayoutItemTags_item_flowChooseable, true);
            singleLine = attrsArray.getBoolean(R.styleable.FlowLayoutItemTags_item_singleLine, false);
            itemWidth = attrsArray.getInt(R.styleable.FlowLayoutItemTags_item_width,
                    FlowLayout.LayoutParams.WRAP_CONTENT);
            if (itemWidth >= 0) {
                itemWidth = DpUtils.sp2px(itemWidth);
            }
            itemHeight = attrsArray.getInt(R.styleable.FlowLayoutItemTags_item_height,
                    FlowLayout.LayoutParams.WRAP_CONTENT);
            if (itemHeight >= 0) {
                itemHeight = DpUtils.sp2px(itemHeight);
            }

            itemMaxEms = attrsArray.getInt(R.styleable.FlowLayoutItemTags_item_maxEms, -1);
            if (itemWidth < 0) {
                itemMaxEms = -1;
            }

            float radius = attrsArray.getDimension(R.styleable.FlowLayoutItemTags_item_radius, 0);
            float topLeftRadius = attrsArray.getDimension(R.styleable.FlowLayoutItemTags_item_topLeftRadius, 0);
            float topRightRadius = attrsArray.getDimension(R.styleable.FlowLayoutItemTags_item_topRightRadius, 0);
            float bottomLeftRadius = attrsArray.getDimension(R.styleable.FlowLayoutItemTags_item_bottomLeftRadius,
                    0);
            float bottomRightRadius = attrsArray
                    .getDimension(R.styleable.FlowLayoutItemTags_item_bottomRightRadius, 0);
            ...
            mStrokeColor = attrsArray.getColorStateList(R.styleable.FlowLayoutItemTags_item_strokeColor);
            mCheckedStrokeColor = attrsArray
                    .getColorStateList(R.styleable.FlowLayoutItemTags_item_selectedStrokeColor);
            mStrokeWidth = (int) attrsArray.getDimension(R.styleable.FlowLayoutItemTags_item_strokeWidth,
                    mStrokeWidth);
    ...
    /**
     * For {@link FlowLayout} save and restore state.
     */
    ...
    class ItemView extends TextView {
        ...
        public ItemView(Context context, CharSequence text) {
            ...
            setLayoutParams(new FlowLayout.LayoutParams(itemWidth, itemHeight));
